...
def create_profile(data):
    try:        
        ...
        profile_for,
        salary_currency,
        salary_preference) VALUES (%s, %s,%s, %s,%s, %s,%s, %s,%s, %s,
        %s, %s,%s, %s,%s, %s,%s, %s,%s, %s,
        %s, %s,%s, %s,%s, %s,%s, %s,%s, %s,
        %s, %s,%s, %s,%s, %s,%s, %s,%s, %s,
        ...
        data['father_name'],data['mother_name'], data['citizenship'],data['profile_for'],data['salary_currency'],data['salary_preference']))                
        connection.commit();        
